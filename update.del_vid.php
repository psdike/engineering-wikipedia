...
<html lang="en">
<head>
  	<title> Update /Delete Videos Engineering Wikipedia | EnWiki </title>
  	<meta charset="utf-8">
...
<center><h1 class="normaltip" title="Welcome to  EN&rArr;WIKI here you get all short notes for various subjects of engineering Education">Engineering Wikipedia</h1></center>
</div>
<div class="container">
<ul id="breadcrumbs-one">
	<li><a href="./">  EN&rArr;WIKI Home </a></li>
	<li><a href="./update.del_notes.php" class="current"> Search videos here. </a></li>
</ul>
...
elseif (isset($_POST['question'])) 					
{
    $cursor= $collection->find( array("title"=>$_POST['question']))->limit(4);
     ...
     foreach ($cursor as $doc) {
        ...
        echo "<dd>".  $doc['link'] ."</dd> </dl>";
echo "<a href=./update_vid.php?id=".$doc['_id']." class=\"info info_warning\">Update</a> &nbsp; &nbsp; &nbsp;" ;
echo "<a href=./delete_vid.php?id=".$doc['_id']." class=\"info info_important\">Delete</a>";
        } 
...
<!-- {
 ...
 -->
<center><a class="btn1" href="advance.php">Click to Advanced Search</a>&nbsp;&nbsp;<a class="btn1" href="./">Go Home</a></center> 
</div>
